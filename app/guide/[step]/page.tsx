...
// ══════════════════════════════════════════════
// CONTENU DES GUIDES — 7 guides en 3 langues
// ══════════════════════════════════════════════
const GUIDES: Record<string, Record<Lang, Guide>> = {
  ...
  ssn: {
    fr: {
      ...
      urgency: "critical",
      cost: "Gratuit",
      time: "1-2h au bureau + 2 semaines par courrier",
      ...
      docs: [
        ...
        { icon: "🟩", label: "Visa immigrant (tampon DV)", desc: "Le tampon dans ton passeport fait office de preuve" },
      ...
      steps: [
        ...
        { title: "Commence ta demande en ligne", desc: "Va sur ssa.gov/ssnumber. Réponds aux questions pour savoir si tu peux finir en ligne ou si tu dois aller au bureau. Depuis janvier 2025, un rendez-vous est obligatoire." },
        { title: "Prends un rendez-vous", desc: "En ligne sur ssa.gov ou par téléphone au 1-800-772-1213 (lundi-vendredi 8h-19h). Appelle tôt le matin pour éviter l'attente. Tu peux aussi aller directement au bureau mais l'attente sera plus longue." },
        { title: "Va au bureau SSA avec tes documents ORIGINAUX", desc: "Arrive 15 minutes avant ton rendez-vous. Apporte TOUS tes documents originaux — le SSA n'accepte aucune photocopie ni document numérique. L'entretien dure environ 20-45 minutes." },
        { title: "Reçois ta carte par courrier", desc: "Ta carte SSN arrive par courrier USPS en 2 semaines. Garde-la dans un endroit sûr et ne la montre qu'à ton employeur ou à la banque. Ne la porte pas dans ton portefeuille." },
      ],
      ...
      faq: [
        ...
        { q: "Mon numéro SSN est-il permanent ?", a: "Oui. Ton SSN ne change jamais. C'est ton numéro pour toute ta vie aux USA." },
    ...
    en: {
      ...
      urgency: "critical",
      cost: "Free",
      time: "1-2h at office + 2 weeks by mail",
      ...
      docs: [
        ...
        { icon: "🟩", label: "Immigrant visa (DV stamp)", desc: "The stamp in your passport serves as proof" },
      ...
      steps: [
        ...
        { title: "Start your application online", desc: "Go to ssa.gov/ssnumber. Answer the questions to see if you can finish online or need to visit an office. Since January 2025, an appointment is required." },
        { title: "Schedule an appointment", desc: "Online at ssa.gov or by phone at 1-800-772-1213 (Mon-Fri 8am-7pm). Call early in the morning to avoid long wait times. Walk-ins are allowed but expect longer waits." },
        { title: "Go to the SSA office with ORIGINAL documents", desc: "Arrive 15 minutes before your appointment. Bring ALL original documents — SSA does not accept photocopies or digital documents. The interview takes about 20-45 minutes." },
        { title: "Receive your card by mail", desc: "Your SSN card arrives by USPS mail in 2 weeks. Keep it somewhere safe and only show it to your employer or bank. Don't carry it in your wallet." },
      ],
    ...
    es: {
      emoji: "🪪",
      title: "Número de Seguro Social (SSN)",
      urgency: "critical",
      cost: "Gratis",
      time: "1-2h en oficina + 2 semanas por correo",
      ...
      docs: [
        ...
        { icon: "🟩", label: "Visa inmigrante (sello DV)", desc: "El sello en tu pasaporte sirve como prueba" },
        { icon: "📄", label: "Formulario I-94", desc: "Imprímelo gratis en i94.cbp.dhs.gov" },
        { icon: "🏠", label: "Prueba de dirección en EE.UU.", desc: "Contrato de arrendamiento, factura o carta de alojamiento" },
      ],
      steps: [
        ...
        { title: "Comienza tu solicitud en línea", desc: "Ve a ssa.gov/ssnumber. Responde las preguntas para ver si puedes terminar en línea o necesitas visitar una oficina. Desde enero 2025, se requiere cita." },
        { title: "Programa una cita", desc: "En línea en ssa.gov o por teléfono al 1-800-772-1213 (lunes-viernes 8am-7pm). Llama temprano en la mañana para evitar largas esperas." },
        { title: "Ve a la oficina SSA con documentos ORIGINALES", desc: "Llega 15 minutos antes de tu cita. Trae TODOS los documentos originales — SSA no acepta fotocopias ni documentos digitales. La entrevista dura unos 20-45 minutos." },
        { title: "Recibe tu tarjeta por correo", desc: "Tu tarjeta SSN llega por correo USPS en 2 semanas. Guárdala en un lugar seguro y solo muéstrala a tu empleador o banco." },
      ],
      ...
      faq: [
        { q: "¿Puedo trabajar sin SSN?", a: "No. Debes esperar tu SSN para trabajar legalmente. Algunos empleadores pueden iniciar el proceso de contratación pero no pueden pagarte sin SSN." },
        { q: "¿Mi SSN es permanente?", a: "Sí. Tu SSN nunca cambia. Es tu número de por vida en EE.UU." },
        { q: "¿Qué pasa si pierdo mi tarjeta SSN?", a: "Ve a ssa.gov para solicitar una tarjeta de reemplazo. Es gratis. Tienes derecho a 3 reemplazos por año y 10 en total en tu vida." },
      ],
      links: [
  ...
  phone: {
    fr: {
      emoji: "📱",
      title: "Carte SIM / Numéro de téléphone US",
      urgency: "critical",
      cost: "$15-$45 premier mois",
      time: "15-30 minutes en magasin",
      ...
      docs: [
        ...
        { icon: "📱", label: "Téléphone débloqué", desc: "Ton téléphone doit être unlocked pour accepter une SIM US" },
      ],
      steps: [
        { title: "Vérifie que ton téléphone est débloqué", desc: "Si tu as acheté ton téléphone avec un opérateur (Orange, MTN, etc.) il peut être verrouillé. Contacte ton opérateur avant de partir pour le débloquer. Un iPhone acheté chez Apple est toujours débloqué." },
        { title: "Choisis un plan prépayé — pas de contrat", desc: "Les plans prépayés ne nécessitent pas de SSN ni de credit score. T-Mobile ($10-$50/mois), Mint Mobile ($15/mois sur réseau T-Mobile), Visible ($25/mois réseau Verizon). Évite les plans postpayés sans SSN." },
        { title: "Achète ta SIM dès l'aéroport ou en magasin", desc: "T-Mobile, AT&T, Verizon ont des kiosques dans la plupart des aéroports. Sinon : Walmart, Target, CVS, ou Best Buy. Tu peux aussi commander en ligne avant ton départ sur mintmobile.com ou t-mobile.com." },
        ...
        { title: "Passe à un plan postpayé plus tard", desc: "Une fois que tu as ton SSN et un credit score, tu peux passer à un plan postpayé moins cher avec plus de données. T-Mobile, AT&T, et Verizon offrent les meilleurs plans." },
      ],
      ...
      faq: [
        { q: "T-Mobile ou Mint Mobile — quelle différence ?", a: "Mint Mobile utilise le réseau T-Mobile mais est moins cher. T-Mobile a de meilleures boutiques physiques et un support client direct. Mint est idéal si tu sais déjà gérer ta SIM seul." },
        { q: "Puis-je garder mon numéro étranger ?", a: "Tu peux garder ton ancien numéro actif pour WhatsApp avec ta carte SIM étrangère, et utiliser ta SIM US comme numéro principal. Beaucoup d'immigrants font ça." },
        { q: "Qu'est-ce qu'un eSIM ?", a: "Un eSIM est une SIM numérique intégrée dans ton téléphone. Pas besoin de carte physique. Les iPhone 14 et plus récents supportent l'eSIM. Mint Mobile et T-Mobile offrent des eSIM." },
      ],
      links: [
        ...
        { icon: "🌐", label: "Vérifier que ton téléphone est débloqué", url: "https://www.t-mobile.com/support/account/unlock-your-device" },
      ],
      aiQuestion: "Quelle SIM prépayée choisir sans SSN aux USA ?",
    },
    en: {
      emoji: "📱",
      title: "SIM Card / US Phone Number",
      urgency: "critical",
      cost: "$15-$45 first month",
      time: "15-30 minutes in store",
      ...
      steps: [
        { title: "Check your phone is unlocked", desc: "If you bought your phone with a carrier, it may be locked. Contact your carrier before leaving to unlock it. iPhones bought directly from Apple are always unlocked." },
        { title: "Choose a prepaid plan — no contract", desc: "Prepaid plans don't require SSN or credit score. T-Mobile ($10-$50/month), Mint Mobile ($15/month on T-Mobile network), Visible ($25/month Verizon network). Avoid postpaid plans without SSN." },
        { title: "Buy your SIM at the airport or in store", desc: "T-Mobile, AT&T, Verizon have kiosks at most airports. Otherwise: Walmart, Target, CVS, or Best Buy. You can also order online before departure at mintmobile.com or t-mobile.com." },
      ...
      faq: [
        { q: "T-Mobile or Mint Mobile — what's the difference?", a: "Mint Mobile uses T-Mobile's network but is cheaper. T-Mobile has better physical stores and direct customer support. Mint is ideal if you can manage your SIM on your own." },
        { q: "Can I keep my foreign number?", a: "You can keep your old number active for WhatsApp with your foreign SIM card, and use your US SIM as your main number. Many immigrants do this." },
        { q: "What is an eSIM?", a: "An eSIM is a digital SIM built into your phone. No physical card needed. iPhone 14 and newer support eSIM. Mint Mobile and T-Mobile offer eSIMs." },
      ],
      links: [
    ...
    es: {
      emoji: "📱",
      title: "SIM Card / Número de teléfono en EE.UU.",
      urgency: "critical",
      cost: "$15-$45 primer mes",
      time: "15-30 minutos en tienda",
      ...
      docs: [
        ...
        { icon: "📱", label: "Teléfono desbloqueado", desc: "Tu teléfono debe estar desbloqueado para aceptar una SIM de EE.UU." },
      ],
      steps: [
        { title: "Verifica que tu teléfono esté desbloqueado", desc: "Si compraste tu teléfono con un operador, puede estar bloqueado. Contacta a tu operador antes de salir para desbloquearlo." },
        ...
        { title: "Cambia a un plan postpago más tarde", desc: "Una vez que tengas tu SSN y puntaje crediticio, puedes cambiar a un plan postpago más económico con más datos." },
      ],
      ...
      faq: [
        { q: "¿T-Mobile o Mint Mobile — cuál es la diferencia?", a: "Mint Mobile usa la red de T-Mobile pero es más barato. T-Mobile tiene mejores tiendas físicas y soporte directo. Mint es ideal si puedes gestionar tu SIM solo." },
  ...
  bank: {
    fr: {
      ...
      urgency: "high",
      cost: "$0-$100 dépôt initial",
      time: "30-45 minutes en agence",
      ...
      steps: [
        { title: "Choisis ta banque", desc: "Chase (4700+ agences) et Bank of America sont les meilleures pour les immigrants — elles acceptent les clients sans SSN avec juste le passeport et une adresse US. Wells Fargo est aussi une bonne option." },
        { title: "Prends rendez-vous en ligne", desc: "Va sur chase.com ou bankofamerica.com pour prendre rendez-vous dans l'agence la plus proche. Certaines agences dans les zones avec beaucoup d'immigrants sont plus habituées au processus." },
        ...
        { title: "Ouvre un compte chèques (checking account)", desc: "Commence par un checking account pour les dépenses quotidiennes. Le dépôt initial est généralement $25-$100. Certains comptes sont gratuits si tu gardes un solde minimum." },
        { title: "Demande une secured credit card", desc: "Dès que tu as ton compte, demande une secured credit card (carte de crédit avec dépôt). C'est le meilleur moyen de commencer à construire ton credit score aux USA. Dépôt requis : $200-$500." },
      ],
      warning: "⚠️ Depuis juin 2025, les banques ont plus de flexibilité pour vérifier l'identité des immigrants. Si une agence te refuse, essaie une autre agence de la même banque ou une autre banque.",
      errors: [
      ...
      faq: [
        { q: "Quelle est la différence entre checking et savings ?", a: "Le checking account est pour les dépenses quotidiennes (carte débit, virements). Le savings account est pour épargner. Commence par le checking et ajoute un savings plus tard." },
        { q: "Puis-je ouvrir un compte sans SSN ?", a: "Oui. Chase, Bank of America, Wells Fargo acceptent juste le passeport + adresse US. Tu n'auras pas d'intérêts sur ton épargne sans SSN, mais tu peux tout utiliser normalement." },
        { q: "Qu'est-ce que le credit score ?", a: "C'est une note de 300 à 850 qui mesure ta fiabilité financière. Plus il est élevé, plus tu peux emprunter à de bons taux. Sans credit score, tu ne peux pas louer un appartement ou acheter une voiture à crédit." },
      ],
      links: [
    ...
    en: {
      ...
      urgency: "high",
      cost: "$0-$100 initial deposit",
      time: "30-45 minutes at branch",
      ...
      docs: [
        ...
        { icon: "🪪", label: "SSN (if you already have it)", desc: "Not required but makes opening easier" },
      ],
      steps: [
        { title: "Choose your bank", desc: "Chase (4700+ branches) and Bank of America are best for immigrants — they accept clients without SSN with just a passport and US address. Wells Fargo is also a good option." },
        ...
        { title: "Go to the branch with all your documents", desc: "You must go in person — you can't open an account online without an SSN. Tell the advisor you're a new DV Lottery immigrant." },
        { title: "Open a checking account", desc: "Start with a checking account for daily expenses. The initial deposit is usually $25-$100. Some accounts are free if you maintain a minimum balance." },
        { title: "Request a secured credit card", desc: "Once you have your account, request a secured credit card (credit card with deposit). It's the best way to start building your US credit score. Required deposit: $200-$500." },
      ],
      warning: "⚠️ Since June 2025, banks have more flexibility to verify immigrant identity. If one branch refuses you, try another branch of the same bank or a different bank.",
      errors: [
      ...
      faq: [
        { q: "What's the difference between checking and savings?", a: "Checking account is for daily spending (debit card, transfers). Savings account is for saving. Start with checking and add savings later." },
        { q: "Can I open an account without SSN?", a: "Yes. Chase, Bank of America, Wells Fargo accept just passport + US address. You won't earn interest on savings without SSN, but you can use everything normally." },
        { q: "What is a credit score?", a: "It's a score from 300 to 850 that measures your financial reliability. The higher it is, the better rates you can borrow at. Without a credit score, you can't rent an apartment or buy a car on credit." },
      ],
      links: [
    ...
    es: {
      ...
      urgency: "high",
      cost: "$0-$100 depósito inicial",
      time: "30-45 minutos en sucursal",
      intro: "Una cuenta bancaria estadounidense es esencial para recibir tu salario, pagar el alquiler y empezar a construir tu historial crediticio. Chase y Bank of America son las mejores opciones para nuevos inmigrantes.",
      docs: [
        ...
        { icon: "🏠", label: "Prueba de dirección en EE.UU.", desc: "Contrato de arrendamiento, factura o carta" },
      ...
      steps: [
        ...
        { title: "Ve a la sucursal con todos tus documentos", desc: "Debes ir en persona — no puedes abrir una cuenta en línea sin SSN. Dile al asesor que eres un nuevo inmigrante de DV Lottery." },
        { title: "Abre una cuenta corriente (checking account)", desc: "Empieza con una cuenta corriente para gastos diarios. El depósito inicial suele ser $25-$100." },
        { title: "Solicita una tarjeta de crédito asegurada", desc: "Una vez que tengas tu cuenta, solicita una tarjeta de crédito asegurada. Es la mejor manera de comenzar a construir tu historial crediticio. Depósito requerido: $200-$500." },
      ],
  ...
  greencard: {
    fr: {
      emoji: "💳",
      title: "Green Card physique",
      urgency: "high",
      cost: "$235 frais USCIS (à payer si pas encore fait)",
      time: "2-3 semaines par courrier USPS",
      intro: "Ta Green Card physique (Form I-551) est la preuve officielle que tu es résident permanent légal des USA. Elle arrive par courrier USPS à ton adresse américaine. Tu dois avoir payé les frais USCIS de $235 pour la recevoir.",
      docs: [
      ...
      steps: [
        { title: "Vérifie si tu as déjà payé les $235 USCIS", desc: "Si tu as payé avant de partir sur uscis.gov/immigrant-fee → ta Green Card est déjà en cours de production. Si tu n'as pas encore payé → fais-le MAINTENANT. Sans ce paiement, ta Green Card ne sera jamais produite." },
        { title: "Paye les frais USCIS si pas encore fait", desc: "Va sur uscis.gov/immigrant-fee. Tu auras besoin de ton A-Number et ton DOS Case ID. Accepte carte crédit, débit, ou compte bancaire US. Coût : $235 par personne. Sans paiement = pas de Green Card." },
        { title: "Configure USPS Informed Delivery", desc: "Crée un compte gratuit sur informeddelivery.usps.com. Tu recevras une photo de chaque courrier AVANT qu'il arrive dans ta boîte. Tu seras prévenu le jour de l'arrivée de ta Green Card." },
        ...
        { title: "Vérifie que tu as la bonne adresse", desc: "Si tu as déménagé depuis l'interview → mets à jour ton adresse IMMÉDIATEMENT sur uscis.gov/addresschange. Sinon ta Green Card ira à la mauvaise adresse." },
      ],
      warning: "⚠️ Ta Green Card n'est valide que 10 ans. Tu devras la renouveler (Form I-90) avant expiration. Garde-la en lieu sûr — ne la porte pas dans ton portefeuille au quotidien.",
      errors: [
        "Ne pas payer les $235 USCIS — ta Green Card ne sera jamais produite",
        "Ne pas mettre à jour ton adresse si tu as déménagé",
        "Ouvrir l'enveloppe scellée de l'ambassade — interdite à l'ouverture avant l'arrivée aux USA",
        "Perdre ta Green Card sans signaler rapidement — commande un remplacement I-90",
      ],
      faq: [
        { q: "Que faire si je ne reçois pas ma Green Card après 90 jours ?", a: "Contacte l'USCIS via uscis.gov/e-request. Tu peux aussi appeler le 1-800-375-5283. Vérifie d'abord que ton adresse est correcte dans le système." },
        { q: "Ma Green Card est-elle valide même en attendant la carte physique ?", a: "Oui ! Le tampon I-551 dans ton passeport est une preuve de résidence permanente valable pendant 1 an. Tu peux travailler et voyager avec ce tampon en attendant ta carte." },
        { q: "Puis-je voyager hors des USA avant de recevoir ma Green Card ?", a: "Oui, avec le tampon I-551 dans ton passeport. Mais informe l'USCIS de ton absence si elle dure plus de 6 mois pour ne pas perdre ton statut." },
      ],
      links: [
        { icon: "🌐", label: "Payer les frais USCIS $235", url: "https://www.uscis.gov/forms/filing-fees/uscis-immigrant-fee" },
        { icon: "🌐", label: "Mettre à jour ton adresse USCIS", url: "https://www.uscis.gov/addresschange" },
    ...
    en: {
      emoji: "💳",
      title: "Physical Green Card",
      urgency: "high",
      cost: "$235 USCIS fee (pay if not done yet)",
      time: "2-3 weeks by USPS mail",
      intro: "Your physical Green Card (Form I-551) is official proof you are a legal permanent resident of the USA. It arrives by USPS mail to your US address. You must have paid the $235 USCIS fee to receive it.",
      docs: [
      ...
      steps: [
        { title: "Check if you already paid the $235 USCIS fee", desc: "If you paid before leaving on uscis.gov/immigrant-fee → your Green Card is already being produced. If you haven't paid yet → do it NOW. Without this payment, your Green Card will never be produced." },
        { title: "Pay the USCIS fee if not done yet", desc: "Go to uscis.gov/immigrant-fee. You'll need your A-Number and DOS Case ID. Accepts credit card, debit, or US bank account. Cost: $235 per person. No payment = no Green Card." },
        ...
        { title: "Make sure your address is correct", desc: "If you've moved since the interview → update your address IMMEDIATELY at uscis.gov/addresschange. Otherwise your Green Card will go to the wrong address." },
      ],
      ...
      faq: [
        { q: "What if I don't receive my Green Card after 90 days?", a: "Contact USCIS via uscis.gov/e-request. You can also call 1-800-375-5283. First check that your address is correct in the system." },
        { q: "Is my Green Card valid while waiting for the physical card?", a: "Yes! The I-551 stamp in your passport is valid proof of permanent residence for 1 year. You can work and travel with this stamp while waiting for your card." },
        { q: "Can I travel outside the USA before receiving my Green Card?", a: "Yes, with the I-551 stamp in your passport. But inform USCIS if your absence lasts more than 6 months so you don't lose your status." },
      ],
      links: [
    ...
    es: {
      emoji: "💳",
      title: "Green Card física",
      urgency: "high",
      cost: "$235 tarifa USCIS (pagar si no se ha hecho)",
      time: "2-3 semanas por correo USPS",
      intro: "Tu Green Card física (Formulario I-551) es la prueba oficial de que eres residente permanente legal de EE.UU. Llega por correo USPS a tu dirección estadounidense. Debes haber pagado la tarifa USCIS de $235 para recibirla.",
      docs: [
        ...
        { icon: "🏠", label: "Dirección confirmada en EE.UU.", desc: "La dirección que diste en la embajada o al CBP" },
      ],
      steps: [
        { title: "Verifica si ya pagaste los $235 de USCIS", desc: "Si pagaste antes de salir en uscis.gov/immigrant-fee → tu Green Card ya está en producción. Si no has pagado → hazlo AHORA. Sin este pago, tu Green Card nunca se producirá." },
        ...
        { title: "Configura USPS Informed Delivery", desc: "Crea una cuenta gratuita en informeddelivery.usps.com. Recibirás una foto de cada pieza de correo ANTES de que llegue a tu buzón. Sabrás el día exacto en que llega tu Green Card." },
        ...
        { title: "Asegúrate de que tu dirección sea correcta", desc: "Si te has mudado desde la entrevista → actualiza tu dirección INMEDIATAMENTE en uscis.gov/addresschange." },
      ],
      warning: "⚠️ Tu Green Card solo es válida por 10 años. Deberás renovarla (Formulario I-90) antes de que expire. Guárdala en un lugar seguro.",
      errors: [
      ...
      faq: [
        { q: "¿Qué pasa si no recibo mi Green Card después de 90 días?", a: "Contacta a USCIS a través de uscis.gov/e-request. También puedes llamar al 1-800-375-5283." },
  ...
  housing: {
    fr: {
      ...
      urgency: "normal",
      cost: "1er mois + dépôt = 2x le loyer",
      time: "1-4 semaines de recherche",
      ...
      steps: [
        { title: "Cherche sur les bons sites", desc: "Zillow.com, Apartments.com, Realtor.com, et Craigslist sont les meilleurs. Facebook Marketplace aussi pour les locations entre particuliers sans agence. Filtre par ta ville et ton budget." },
        { title: "Contacte directement les propriétaires", desc: "Les propriétaires privés sont plus flexibles que les grandes agences immobilières. Explique ta situation d'immigrant récent et propose un dépôt plus important pour rassurer." },
        { title: "Prépare ton dossier de location", desc: "Lettre de motivation expliquant ta situation, relevés bancaires, contrat de travail si tu en as un, et références personnelles. Un garant américain peut aussi t'aider." },
        { title: "Négocie si tu n'as pas de credit score", desc: "Sans credit score, propose 2-3 mois de loyer d'avance. Beaucoup de propriétaires acceptent ça. Tu peux aussi proposer un co-signataire (quelqu'un avec un bon credit score qui garantit pour toi)." },
        { title: "Signe le bail et configure tes services", desc: "Avant de signer, lis TOUT le bail. Configure l'électricité (BGE, Pepco selon ton état), internet, et l'eau. Ces factures aident aussi à construire ton historique de crédit." },
      ],
      ...
      errors: [
        ...
        "Signer un bail sans le lire entièrement — vérifie les pénalités de départ anticipé",
      ...
      faq: [
        { q: "Puis-je louer sans credit score ?", a: "Oui, en proposant 2-3 mois de loyer d'avance ou en trouvant un garant. Les propriétaires privés sont beaucoup plus flexibles que les grandes agences." },
        { q: "Qu'est-ce que le Section 8 ?", a: "C'est un programme d'aide au logement du gouvernement américain. Si tes revenus sont bas, tu peux demander une aide financière pour le loyer. Contacte ton housing authority local." },
        { q: "Comment construire mon historique de location ?", a: "Paye ton loyer à temps chaque mois. Certains services comme Rental Kharma ou RentReporters rapportent tes paiements aux bureaux de crédit pour te donner un credit score." },
      ],
      links: [
    ...
    en: {
      ...
      title: "Find Housing",
      urgency: "normal",
      cost: "1st month + deposit = 2x rent",
      time: "1-4 weeks of searching",
      ...
      steps: [
        { title: "Search on the right sites", desc: "Zillow.com, Apartments.com, Realtor.com, and Craigslist are the best. Facebook Marketplace too for private rentals without an agency. Filter by your city and budget." },
        { title: "Contact landlords directly", desc: "Private landlords are more flexible than big property management companies. Explain your situation as a recent immigrant and offer a larger deposit to reassure them." },
        { title: "Prepare your rental application", desc: "Cover letter explaining your situation, bank statements, employment contract if you have one, and personal references. A US guarantor can also help." },
        { title: "Negotiate if you don't have a credit score", desc: "Without a credit score, offer 2-3 months of rent upfront. Many landlords accept this. You can also offer a co-signer (someone with a good credit score who guarantees for you)." },
      ...
      errors: [
        ...
        "Signing a lease without reading it fully — check early termination penalties",
        "Only searching through big agencies — private landlords are more flexible",
        "Not asking for a receipt for every payment",
      ],
      faq: [
        { q: "Can I rent without a credit score?", a: "Yes, by offering 2-3 months of rent upfront or finding a guarantor. Private landlords are much more flexible than big agencies." },
        { q: "What is Section 8?", a: "It's a US government housing assistance program. If your income is low, you can apply for financial help with rent. Contact your local housing authority." },
        { q: "How do I build my rental history?", a: "Pay your rent on time every month. Services like Rental Kharma or RentReporters report your payments to credit bureaus to give you a credit score." },
      ],
      links: [
    ...
    es: {
      emoji: "🏠",
      title: "Encontrar vivienda",
      urgency: "normal",
      cost: "1er mes + depósito = 2x el alquiler",
      time: "1-4 semanas de búsqueda",
      ...
      steps: [
        ...
        { title: "Contacta directamente a los propietarios", desc: "Los propietarios privados son más flexibles que las grandes empresas de gestión. Explica tu situación como inmigrante reciente y ofrece un depósito mayor." },
        { title: "Prepara tu solicitud de alquiler", desc: "Carta de presentación explicando tu situación, estados de cuenta bancarios, contrato de trabajo si tienes uno, y referencias personales." },
      ...
      faq: [
        ...
        { q: "¿Qué es la Sección 8?", a: "Es un programa de asistencia de vivienda del gobierno de EE.UU. Si tus ingresos son bajos, puedes solicitar ayuda financiera para el alquiler." },
  ...
  job: {
    fr: {
      ...
      urgency: "normal",
      cost: "Gratuit",
      time: "2-8 semaines selon le secteur",
      ...
      docs: [
        ...
        { icon: "📄", label: "CV format américain", desc: "1 page max, sans photo, sans âge, sans adresse complète" },
        { icon: "📧", label: "Adresse email professionnelle", desc: "Gmail avec ton vrai nom — pas de surnom" },
      ],
      steps: [
        { title: "Crée ton profil LinkedIn", desc: "LinkedIn est essentiel aux USA. Crée un profil complet avec photo professionnelle, tes expériences, et tes compétences. Connecte-toi avec des gens dans ton secteur. 75% des emplois sont trouvés par le réseau." },
        { title: "Adapte ton CV au format américain", desc: "1 page maximum. Pas de photo, pas d'âge, pas de situation familiale. Commence par tes expériences les plus récentes. Utilise des chiffres pour quantifier tes résultats. En anglais uniquement." },
        { title: "Postule sur les bons sites", desc: "Indeed.com, LinkedIn Jobs, Glassdoor, et ZipRecruiter sont les meilleurs. Pour les emplois gouvernementaux : USAJOBS.gov. Pour les emplois tech : Dice.com. Postule à 20-30 offres par semaine minimum." },
        { title: "Prépare tes entretiens", desc: "Les entretiens américains sont différents. Sois direct, positif, et parle de tes accomplissements avec des chiffres. Prépare des réponses STAR (Situation, Tâche, Action, Résultat). Souris et sois confiant." },
        { title: "Remplis le formulaire I-9 à l'embauche", desc: "Tous les employeurs doivent vérifier ton droit de travailler via le formulaire I-9. Apporte ta Green Card (ou tampon I-551) et ton SSN. C'est obligatoire pour tous les employeurs US." },
      ],
      warning: "⚠️ Ne travaille JAMAIS sans avoir ton SSN. Les employeurs qui acceptent de te payer en cash sans SSN te mettent en danger légalement et toi aussi.",
      errors: [
        "Travailler sans SSN — illégal pour toi et l'employeur",
        "Envoyer un CV avec photo ou age — éliminatoire aux USA",
        "Ne pas adapter son CV au marché américain",
        "Ignorer LinkedIn — c'est le réseau professionnel numéro 1 aux USA",
      ],
      faq: [
        { q: "Ai-je besoin d'une autorisation de travail supplémentaire ?", a: "Non ! En tant que résident permanent DV Lottery, tu as le droit de travailler dans n'importe quel emploi aux USA sans autorisation supplémentaire. Ta Green Card suffit." },
        { q: "Comment faire reconnaître mon diplôme étranger ?", a: "Contacte des services comme World Education Services (WES) ou Educational Credential Evaluators (ECE) pour faire évaluer et reconnaître ton diplôme étranger." },
        { q: "Puis-je créer ma propre entreprise ?", a: "Oui ! En tant que résident permanent, tu peux créer une LLC ou une entreprise individuelle. Contacte la Secretary of State de ton état pour les démarches." },
      ],
      links: [
    ...
    en: {
      ...
      urgency: "normal",
      cost: "Free",
      time: "2-8 weeks depending on sector",
      ...
      docs: [
        ...
        { icon: "📄", label: "US-format resume", desc: "1 page max, no photo, no age, no full address" },
        { icon: "📧", label: "Professional email address", desc: "Gmail with your real name — no nickname" },
      ],
      steps: [
        { title: "Create your LinkedIn profile", desc: "LinkedIn is essential in the USA. Create a complete profile with professional photo, your experiences, and skills. Connect with people in your field. 75% of jobs are found through networking." },
        { title: "Adapt your resume to US format", desc: "1 page maximum. No photo, no age, no family situation. Start with most recent experience. Use numbers to quantify your results. English only." },
        { title: "Apply on the right sites", desc: "Indeed.com, LinkedIn Jobs, Glassdoor, and ZipRecruiter are the best. For government jobs: USAJOBS.gov. For tech jobs: Dice.com. Apply to 20-30 positions per week minimum." },
        { title: "Prepare for interviews", desc: "US interviews are different. Be direct, positive, and talk about your accomplishments with numbers. Prepare STAR answers (Situation, Task, Action, Result). Smile and be confident." },
        { title: "Complete Form I-9 at hiring", desc: "All employers must verify your right to work via Form I-9. Bring your Green Card (or I-551 stamp) and SSN. This is required for all US employers." },
      ],
      ...
      faq: [
        { q: "Do I need additional work authorization?", a: "No! As a DV Lottery permanent resident, you have the right to work in any job in the USA without additional authorization. Your Green Card is enough." },
        { q: "How do I get my foreign degree recognized?", a: "Contact services like World Education Services (WES) or Educational Credential Evaluators (ECE) to evaluate and recognize your foreign degree." },
        { q: "Can I start my own business?", a: "Yes! As a permanent resident, you can create an LLC or sole proprietorship. Contact your state's Secretary of State for the steps." },
      ],
      links: [
    ...
    es: {
      ...
      urgency: "normal",
      cost: "Gratis",
      time: "2-8 semanas según el sector",
      ...
      steps: [
        { title: "Crea tu perfil de LinkedIn", desc: "LinkedIn es esencial en EE.UU. Crea un perfil completo con foto profesional, tus experiencias y habilidades. El 75% de los trabajos se encuentran a través de la red de contactos." },
        { title: "Adapta tu CV al formato americano", desc: "1 página máximo. Sin foto, sin edad, sin situación familiar. Comienza con la experiencia más reciente. Usa números para cuantificar tus resultados." },
        { title: "Postula en los sitios correctos", desc: "Indeed.com, LinkedIn Jobs, Glassdoor y ZipRecruiter son los mejores. Para empleos gubernamentales: USAJOBS.gov. Postula a 20-30 ofertas por semana mínimo." },
        { title: "Prepárate para las entrevistas", desc: "Las entrevistas en EE.UU. son diferentes. Sé directo, positivo y habla de tus logros con números. Prepara respuestas STAR (Situación, Tarea, Acción, Resultado)." },
        { title: "Completa el Formulario I-9 al contratar", desc: "Todos los empleadores deben verificar tu derecho a trabajar mediante el Formulario I-9. Lleva tu Green Card (o sello I-551) y SSN." },
      ],
      ...
      faq: [
        { q: "¿Necesito autorización de trabajo adicional?", a: "¡No! Como residente permanente de DV Lottery, tienes derecho a trabajar en cualquier empleo en EE.UU. sin autorización adicional. Tu Green Card es suficiente." },
        { q: "¿Cómo hago reconocer mi título extranjero?", a: "Contacta servicios como World Education Services (WES) o Educational Credential Evaluators (ECE) para evaluar y reconocer tu título extranjero." },
        { q: "¿Puedo crear mi propia empresa?", a: "¡Sí! Como residente permanente, puedes crear una LLC o empresa individual. Contacta al Secretario de Estado de tu estado." },
      ],
      links: [
  ...
  license: {
    fr: {
      emoji: "🚗",
      title: "Permis de conduire US",
      urgency: "normal",
      cost: "$50-$100 selon l'état",
      time: "1-2 jours (examen + visite DMV)",
      ...
      steps: [
        { title: "Passe l'examen théorique en ligne d'abord", desc: "Va sur le site du DMV de ton état (ex: mva.maryland.gov pour le Maryland). Télécharge le manuel de conduite de ton état. Passe des examens blancs sur dmv-written-test.com. Tu as besoin d'environ 70-80% pour réussir." },
        { title: "Prends rendez-vous au DMV", desc: "Va sur le site du DMV de ton état pour prendre rendez-vous. Certains états permettent les walk-ins mais l'attente peut être de 2-4h. Prends rendez-vous pour éviter d'attendre." },
        { title: "Va au DMV avec tous tes documents", desc: "Apporte tous tes documents ORIGINAUX. Le DMV vérifie ton identité, ta résidence légale, et ton adresse. Si un document manque, ils te renverront chez toi." },
        { title: "Passe l'examen pratique (road test)", desc: "Après avoir réussi l'examen théorique, tu devras passer un examen pratique de conduite. Amène un véhicule assuré. L'examen dure 15-20 minutes. Tu peux reprendre si tu rates." },
        { title: "Reçois ton permis temporaire puis permanent", desc: "Tu reçois d'abord un permis temporaire papier le jour J. Le permis plastique arrive par courrier en 1-2 semaines. Configure USPS Informed Delivery pour suivre la livraison." },
      ],
      warning: "⚠️ Certains états offrent l'option REAL ID — c'est recommandé car depuis mai 2025, le REAL ID est requis pour prendre l'avion aux USA. Cochez l'option REAL ID au DMV.",
      errors: [
      ...
      faq: [
        { q: "Puis-je conduire avec mon permis étranger en attendant ?", a: "Oui, pour une durée limitée selon les états (30-90 jours en général). Après, tu dois avoir un permis américain. Vérifie les règles de ton état." },
        { q: "Qu'est-ce que le REAL ID ?", a: "C'est un permis avec une étoile dorée en haut à droite. Depuis mai 2025, il est requis pour prendre l'avion intérieur aux USA. Demande-le au DMV dès le début." },
        { q: "Mon permis international est-il valide aux USA ?", a: "Un Permis de Conduire International (PCI) est accepté en complément de ton permis national. Mais ce n'est pas suffisant seul — tu dois aussi avoir ton permis de ton pays d'origine." },
      ],
      links: [
    ...
    en: {
      ...
      urgency: "normal",
      cost: "$50-$100 depending on state",
      time: "1-2 days (exam + DMV visit)",
      ...
      steps: [
        ...
        { title: "Schedule a DMV appointment", desc: "Go to your state's DMV website to schedule an appointment. Some states allow walk-ins but wait times can be 2-4 hours. Schedule to avoid waiting." },
        { title: "Go to the DMV with all your documents", desc: "Bring all ORIGINAL documents. The DMV checks your identity, legal residency, and address. If a document is missing, they'll send you home." },
        { title: "Take the road test", desc: "After passing the written test, you'll need to take a practical driving test. Bring an insured vehicle. The test lasts 15-20 minutes. You can retake if you fail." },
        { title: "Receive temporary then permanent license", desc: "You receive a temporary paper license on the day. The plastic license arrives by mail in 1-2 weeks. Set up USPS Informed Delivery to track delivery." },
      ],
      warning: "⚠️ Some states offer the REAL ID option — recommended because since May 2025, REAL ID is required to fly within the USA. Check the REAL ID option at the DMV.",
      errors: [
      ...
      faq: [
        { q: "Can I drive with my foreign license while waiting?", a: "Yes, for a limited time depending on state (usually 30-90 days). After that, you need a US license. Check your state's rules." },
        { q: "What is REAL ID?", a: "It's a license with a gold star in the top right corner. Since May 2025, it's required for domestic flights within the USA. Request it at the DMV from the start." },
        { q: "Is my international license valid in the USA?", a: "An International Driver's Permit (IDP) is accepted alongside your national license. But it's not sufficient alone — you must also have your home country license." },
      ],
      links: [
    ...
    es: {
      emoji: "🚗",
      title: "Licencia de conducir de EE.UU.",
      urgency: "normal",
      cost: "$50-$100 según el estado",
      time: "1-2 días (examen + visita al DMV)",
      ...
      steps: [
        { title: "Haz el examen teórico en línea primero", desc: "Ve al sitio web del DMV de tu estado. Descarga el manual de conducción de tu estado. Practica en dmv-written-test.com. Necesitas aproximadamente 70-80% para aprobar." },
        { title: "Programa una cita en el DMV", desc: "Ve al sitio web del DMV de tu estado para programar una cita. Algunos estados permiten entradas sin cita, pero la espera puede ser de 2-4 horas." },
        { title: "Ve al DMV con todos tus documentos", desc: "Lleva todos los documentos ORIGINALES. El DMV verifica tu identidad, residencia legal y dirección." },
      ...
      warning: "⚠️ Algunos estados ofrecen la opción REAL ID — recomendado porque desde mayo 2025, se requiere REAL ID para volar dentro de EE.UU.",
      errors: [
      ...
      faq: [
        ...
        { q: "¿Es válida mi licencia internacional en EE.UU.?", a: "Un Permiso Internacional de Conducción se acepta junto con tu licencia nacional." },
      ],
      links: [
        { icon: "🌐", label: "DMV Maryland (MVA)", url: "https://mva.maryland.gov" },
    ...
    const check = async () => {
      ...
      try {
        ...
        if (snap.exists()) {
          ...
          setCompleted(steps.includes(stepId));
        }
      } catch { /* continue */ }
    };
    check();
      ...
      <div style={{ padding:"20px 16px 80px", maxWidth:480, margin:"0 auto", opacity:mounted?1:0, transition:"opacity 0.4s ease" }}>
        ...
        <div style={{ marginBottom:20 }}>
          <div style={{ fontSize:11, color:"#555", letterSpacing:"0.1em", textTransform:"uppercase" as const, marginBottom:12, fontWeight:600 }}>
            📋 {lang==="fr"?"Documents à préparer":lang==="es"?"Documentos a preparar":"Documents to prepare"}
          </div>
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            {guide.docs.map((d, i) => (
              <div key={i} onClick={() => setCheckedDocs(prev => ({ ...prev, [i]:!prev[i] }))} style={{ background:"#141d2e", border:"1px solid "+(checkedDocs[i]?"rgba(34,197,94,0.3)":"#1e2a3a"), borderRadius:12, padding:"12px 14px", display:"flex", alignItems:"center", gap:12, cursor:"pointer", transition:"border-color 0.2s" }}>
                <div style={{ width:28, height:28, borderRadius:8, border:"2px solid "+(checkedDocs[i]?"#22c55e":"#2a3448"), background:checkedDocs[i]?"#22c55e":"transparent", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, transition:"all 0.2s" }}>
                  {checkedDocs[i] && <svg width="12" height="10" viewBox="0 0 12 10" fill="none"><path d="M1 5L4.5 8.5L11 1" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>}
                </div>
                <div style={{ fontSize:20, flexShrink:0 }}>{d.icon}</div>
                <div style={{ flex:1, minWidth:0 }}>
                  <div style={{ fontSize:13, fontWeight:600, color:checkedDocs[i]?"#555":"#f4f1ec", textDecoration:checkedDocs[i]?"line-through":"none" }}>{d.label}</div>
            ...
            {guide.steps.map((step, i) => (
              <div key={i} style={{ display:"flex", gap:12 }}>
                <div style={{ display:"flex", flexDirection:"column", alignItems:"center" }}>
                  <div style={{ width:32, height:32, borderRadius:"50%", background: i === 0 ? urgency.color : "#1e2a3a", border:"2px solid "+(i===0?urgency.color:"#2a3448"), display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, fontWeight:700, color: i===0?"#000":"#aaa", flexShrink:0 }}>
                    {i + 1}
                  </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
            {guide.faq.map((item, i) => (
              <div key={i} style={{ background:"#141d2e", border:"1px solid "+(openFaq===i?"rgba(232,184,75,0.3)":"#1e2a3a"), borderRadius:12, overflow:"hidden", transition:"border-color 0.2s" }}>
                ...
                {openFaq===i && (
                  <div style={{ padding:"0 14px 14px", fontSize:13, color:"#aaa", lineHeight:1.7, borderTop:"1px solid #1e2a3a", paddingTop:12 }}>
                    {item.a}
                  </div>
                )}
              </div>
        ...
        {/* Explorer button si disponible */}
        {guide.explorerFilter && (
          <button
            onClick={() => window.location.href=`/dashboard?tab=explorer&filter=${guide.explorerFilter}`}
        ...
        <button
          onClick={() => {
            localStorage.setItem("aiQuestion", guide.aiQuestion);
            window.location.href = "/chat";
          }}
          style={{ width:"100%", marginBottom:20, padding:"13px 16px", background:"linear-gradient(135deg,rgba(232,184,75,0.1),rgba(45,212,191,0.06))", border:"1px solid rgba(232,184,75,0.3)", borderRadius:14, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"space-between", fontFamily:"inherit" }}
        >
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
        ...
        <button
          ...
          disabled={marking}
          style={{ width:"100%", padding:"15px", background:completed?"rgba(34,197,94,0.1)":"#22c55e", color:completed?"#22c55e":"#000", border:completed?"1px solid rgba(34,197,94,0.3)":"none", borderRadius:24, fontWeight:700, fontSize:15, cursor:"pointer", fontFamily:"inherit", marginBottom:10, display:"flex", alignItems:"center", justifyContent:"center", gap:8, opacity:marking?0.7:1 }}
        >
          {marking ? "..." : completed
            ? (lang==="fr"?"✓ Étape complétée — Retirer":lang==="es"?"✓ Paso completado — Quitar":"✓ Step completed — Undo")
        ...
        <button
          ...
          style={{ width:"100%", padding:"13px", background:"transparent", border:"1px solid rgba(232,184,75,0.3)", borderRadius:24, color:"#e8b84b", fontSize:14, cursor:"pointer", fontFamily:"inherit" }}
        >
