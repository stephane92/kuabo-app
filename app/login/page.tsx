...
export default function LoginPage() {
  ...
  // ── Login Google — signInWithPopup PARTOUT ────
  // ✅ RÈGLE CRITIQUE : signInWithPopup partout (jamais redirect)
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (err.code === "auth/popup-blocked") {
        setError(
          lang === "fr"
            ? "Popup bloqué. Autorise les popups pour ce site dans les réglages Safari."
            : "Popup blocked. Allow popups for this site in Safari settings."
        );
        return;
      }
    ...
    <div style={{ minHeight:"100dvh", background:"#0b0f1a", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"80px 16px 24px", color:"#f4f1ec" }}>
      ...
      <div style={{ width:"100%", maxWidth:380, background:"#0f1521", border:"1px solid #1e2a3a", borderRadius:20, padding:"24px 16px" }}>
        ...
        <div style={{ position:"relative", marginBottom:6 }}>
          <input
            type={showPass?"text":"password"} placeholder={t.passPlaceholder} value={pass}
